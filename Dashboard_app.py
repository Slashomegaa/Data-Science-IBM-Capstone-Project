...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df['class'] = filtered_df['class'].replace(0,'Failed')
        filtered_df['class'] = filtered_df['class'].replace(1,'Success')
        fig = px.pie(filtered_df, values='class count',names='class',title=f'Total Success Launches for site {entered_site}', color='class',
